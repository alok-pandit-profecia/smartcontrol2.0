...
export default class Dropdown extends PureComponent {
  ...
  render() {
    ...
    return (
      <TouchableOpacity onPress={this.onPress} onLayout={this.onLayout} ref={this.updateContainerRef} style={containerStyle}>
        <TouchableOpacity onPress={this.onPress} {...touchableProps}>
