...
const AlertComponentForEstblishmentInformation = (props: any) => {
                    ...
                    <View style={{ flex: 5, justifyContent: 'center', borderTopLeftRadius: 20, borderTopRightRadius: 20, borderRadius: 20 }}>
                        ...
                        <View style={{ height: 'auto',  }}>
                            <TextComponent
                                ...
                                label={`Establishment Name:${props.data.EnglishName ? props.data.EnglishName : ' - '}`}
                            />
                            <TextComponent
                                numberOfLines={1}
                                textStyle={[styles.confirmMsg, { color: '#5c666f', textAlign: 'left', fontSize: 13, fontWeight: 'normal' }]}
                                label={` Establishment LicenseNumber: ${props.data.LicenseCode ? props.data.LicenseCode :" - "}`}
                            />
                            <TextComponent
                                numberOfLines={1}
                                textStyle={[styles.confirmMsg, { color: '#5c666f', textAlign: 'left', fontSize: 13, fontWeight: 'normal' }]}
                                label={`Establishment Sector: ${props.data.Sector ? props.data.Sector : " - "}`}
                            />
                            <TextComponent
                                numberOfLines={1}
                                textStyle={[styles.confirmMsg, { color: '#5c666f', textAlign: 'left', fontSize: 13, fontWeight: 'normal' }]}
                                label={`Establishment City:${props.data.City ? props.data.City : " - "}`}
                            />
                            {/* <TextComponent
                                numberOfLines={1}
                                textStyle={[styles.confirmMsg, { color: '#5c666f', textAlign: 'left', fontSize: 13, fontWeight: 'normal' }]}
...
export default AlertComponentForEstblishmentInformation;