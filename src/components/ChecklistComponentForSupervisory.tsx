...
const ChecklistComponentForSupervisory = (props: any) => {
    ...
    const [SupervisoryArray, setSupervisoryArray] = useState(Array());
    ...
    useEffect(() => {
        debugger;
        setSupervisoryArray(props.data ? props.data : []);
    ...
    const renderData = (item: any, index: number) => {
        ...
        // console.log('index' + item.Supervisory_parameter_category);
                ...
                <View style={{ flex: 1, width: '100%', alignItems: 'center' }}>
                    ...
                    <View style={{ flex: 2, width: '100%', flexDirection: props.isArabic ? 'row-reverse' : 'row', justifyContent: 'space-evenly', alignItems: 'center' }}>
                        ...
                        <Menu renderer={Popover} rendererProps={{ preferredPlacement: 'bottom' }}>
                            ...
                            <MenuTrigger onPress={() => { }} disabled={myTasksDraft.isMyTaskClick == 'CompletedTask' || (item.NAValue == 'Y')} style={styles.menuTrigger}>

                                <View
                                    style={{ width: 90, padding: 5, borderRadius: 15, backgroundColor: '#5c666f', justifyContent: 'center', alignItems: 'center' }}>

                                    <TextComponent
                                        textStyle={{ color: '#ffffff', textAlign: 'left', fontSize: 11, fontWeight: 'normal' }}
                                        label={item.Score ? item.Score : 'Satisfactory'}
                                    />
                            ...
                            <MenuOptions style={styles.menuOptions}>
                                ...
                                <MenuOption onSelect={() => {
                                    ...
                                    item.Score = '-';
                                    item.Comment2 = '';
                                    props.onComplianceClick(item, index, '-')
                                }}>
                                    <TextComponent
                                ...
                                <MenuOption onSelect={() => {
                                    setTouchableClick(false);
                                    item.NA = 'N';
                                    item.Score = 'Satisfactory';
                                    item.Comment2 = '';
                                    props.onComplianceClick(item, index, 'Satisfactory');
                                ...
                                <MenuOption onSelect={() => {
                                    setTouchableClick(false);
                                    item.NA = 'N';
                                    item.Score = 'Unsatisfactory';
                                    item.Comment2 = '';
                                    props.onComplianceClick(item, index, 'Unsatisfactory');
                                }}>
                                    <TextComponent
                                        textStyle={{ color: '#5c666f', textAlign: 'left', fontSize: 11, fontWeight: 'normal' }}
                                ...
                                <MenuOption onSelect={() => {
                                    ...
                                    item.Score = 'NA';
                                    item.Comment2 = '';
                                    props.onComplianceClick(item, index, 'NA');
                                }}>
                                    <TextComponent
                                        textStyle={{ color: '#5c666f', textAlign: 'left', fontSize: 11, fontWeight: 'normal' }}
                                        label={'NA'}
...
export default observer(ChecklistComponentForSupervisory);
